  ...
  document.getElementById('mobil').classList.add('active');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div>
                                <form class="user" method="POST" action="{{ url('/admin/mobil/ubah/post/'.$vehicle->id) }}">
                                {{ csrf_field() }}
                                    <div class="d-flex justify-content-center my-3">
                                        <div class="col-12 col-sm-6 col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="license_plate" type="text" class="form-control" id="input2" value="{{ $vehicle->license_plate }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input3" class="col-sm-3 col-form-label">Merk</label>
                                                <div class="col-sm-9">
                                                    <input name="brand" type="text" class="form-control" id="input3" value="{{ $vehicle->brand }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input4" class="col-sm-3 col-form-label">Tipe</label>
                                                <div class="col-sm-9">
                                                    <input name="type" type="text" class="form-control" id="input4" value="{{ $vehicle->type }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input5" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-9">
                                                    <input name="color" type="text" class="form-control" id="input5" value="{{ $vehicle->color }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="chair_amount" type="text" class="form-control" id="input7" value="{{ $vehicle->chair_amount }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="price" type="text" class="form-control" id="input9" value="{{ $vehicle->price }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input10" class="col-sm-3 col-form-label">Tanggal Tenggang Pajak</label>
                                                <div class="col-sm-9">
                                                    <input name="tax_payment_date" type="text" class="form-control picker" id="input10" value="{{ $vehicle->tax_payment_date }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="license_plate_expiration_date" type="text" class="form-control picker" id="input12" value="{{ $vehicle->license_plate_expiration_date }}">
                                                </div>
                                            </div>
