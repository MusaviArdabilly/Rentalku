...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark6 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item" id="dashboard">
                <a class="nav-link" href="{{ asset('/super-admin/dashboard') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span></a>
            </li>            
            ...
            <li class="nav-item" id="manage_user">
                <a class="nav-link" href="{{ asset('/super-admin/management_user') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>User</span></a>
            </li>            
            ...
            <li class="nav-item" id="manage_agent">
                <a class="nav-link" href="{{ asset('/super-admin/management_agent') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Agent</span></a>
            </li>            
