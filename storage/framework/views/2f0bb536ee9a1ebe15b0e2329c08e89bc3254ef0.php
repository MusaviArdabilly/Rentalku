...
<head>
    ...
    <link href="<?php echo e(asset('css/additional.css')); ?>" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark6 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item" id="profil">
                <a class="nav-link" href="<?php echo e(url('/a/'.auth()->user()->username)); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Profil</span></a>
            </li>
            ...
            <li class="nav-item" id="mobil">
                <a class="nav-link" href="<?php echo e(asset('/admin/mobil')); ?>">
            ...
            <li class="nav-item" id="transaksi">
                <a class="nav-link" href="<?php echo e(asset('/admin/transaksi')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item" id="pajak">
                <a class="nav-link" href="<?php echo e(asset('/admin/pajak')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Pajak</span></a>
            </li>

            <li class="nav-item" id="perawatan">
                <a class="nav-link" id="perawatan" href="<?php echo e(asset('/admin/perawatan')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                src="<?php echo e(asset("storageImages/profile/".Auth::user()->picture)); ?>">
                                
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo e(url('/a/'.auth()->user()->username)); ?>">
    ...
    <script src="<?php echo e(asset('js/hide_upload_button.js')); ?>"></script>

    <!-- Popper  -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>

    <!-- Date Time Picker  -->
    <script src="<?php echo e(asset('vendor/jquery/jquery.datetimepicker.full.min.js')); ?>"></script>
    <script>
        $(function () {
...
</html><?php /**PATH C:\NoFiles\Project\Web\Laravel\Rentalku\resources\views/layout/adminlayout.blade.php ENDPATH**/ ?>