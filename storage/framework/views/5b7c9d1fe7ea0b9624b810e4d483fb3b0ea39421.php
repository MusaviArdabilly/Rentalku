                        ...
                        <ul class="navbar-nav ml-md-0">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-dark dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="text-light dropdown-item" href="<?php echo e(url('/u/'.auth()->user()->username)); ?>">Profil</a>
...
</html><?php /**PATH C:\NoFiles\Project\Web\Laravel\Rentalku\resources\views/layout/userlayout.blade.php ENDPATH**/ ?>